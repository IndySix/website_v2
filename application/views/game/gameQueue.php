<div style="padding: 10px">
	<?PHP foreach ($queue as $key => $value): ?>
		<div style="padding: 5px; margin: 10px 0px; background-color: orange; height: 40px;line-height: 40px; font-size: 20px;">
			<div style="display: inline-block; width: 40px; height: 40px; background-color: red; text-align:center; font-weight: bold;">
				<?PHP echo $key == 0 ? '>' : $key ?>
			</div>
